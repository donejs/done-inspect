# Contributing to done-inspect

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/donejs/done-inspect) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork done-inspect, you can start by going to its [fork page](https://github.com/donejs/done-inspect/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/done-inspect
```
