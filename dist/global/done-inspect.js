...
/*done-inspect@0.0.6#done-inspect.stache!steal-stache@3.0.5#steal-stache*/
define('done-inspect/done-inspect.stache', [
    ...
    var renderer = stache([
        ...
        {
            'tokenType': 'attrValue',
            'args': ['done-inspect-plugin-application-title']
        },
        {
            'tokenType': 'attrEnd',
            'args': ['class']
...
/*done-inspect@0.0.6#modules/select-wand/select-wand*/
...
/*done-inspect@0.0.6#modules/show-names/show-names*/
...
/*done-inspect@0.0.6#modules/group.stache!steal-stache@3.0.5#steal-stache*/
...
/*done-inspect@0.0.6#modules/module.stache!steal-stache@3.0.5#steal-stache*/
...
/*done-inspect@0.0.6#done-inspect*/
define('done-inspect', [
    'exports',
    'lodash',
    'can-component',
